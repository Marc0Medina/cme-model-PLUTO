...
infile = open("omni2194.txt", "r") # reads file
...
# different formats:
ax = axs[0]
KMS_resize=np.resize(KMS,(101))
datee=np.resize(date_strings,(101))
doscuarentah=[]
print(len(KMS))
print()
#print(KMS)
fechas=[]
#for a in datee:
#	ab=datetime.strptime(a, '%Y/%m/%d-%H:00')
#	fechas.append(ab)
#ax1.plot(date, vr1au , 'blue', linewidth=3, label='Modelo')
#plt.plot(time_h_resize[frame_vec], vr1au_resize , 'blue', linewidth=3, ma$
#
#print(len(date_strings))
#print(date_strings[330:431])
ax.plot(date_strings[:], KMS[:]   , label='OMNI')
