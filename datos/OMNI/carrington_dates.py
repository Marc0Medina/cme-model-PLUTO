...
def get_time_interval(case_study):
    ...
    elif case_study == "cr2165":
        # Carrington Rotation 2238
        # 2015 Jun 17 to Jul 14
        starttime = dt.datetime(year=2015, month=6, day=17)
        endtime = dt.datetime(year=2015, month=7, day=14)
        cr = "2238"
        
#2165 	2015 Jun 17 	1517 	2015 Jul 14 	2004 	Plot 	List
    elif case_study == "cr2194":
        # Carrington Rotation 2238
        # 2017 Aug 16 to Sep 12
        starttime = dt.datetime(year=2017, month=8, day=16)
        endtime = dt.datetime(year=2017, month=9, day=12)
        cr = "2238"
        ...
        cr = "2238"
    elif case_study == "cr2250":
        # Carrington Rotation 2238
        # 2021 Oct 21 to Nov 18
        starttime = dt.datetime(year=2021, month=10, day=21)
        endtime = dt.datetime(year=2021, month=11, day=18)
        cr = "2238"
    elif case_study == "cr2255":
        # Carrington Rotation 2255
        # 2022 Mar 7 to Apr 3
        starttime = dt.datetime(year=2022, month=3, day=7)
        endtime = dt.datetime(year=2022, month=4, day=3)
        cr = "2238"
        
#2255 	2022 Mar 07 	1200 	2022 Apr 03 	1919 	Plot 	List
#2250 	2021 Oct 21 	2056 	2021 Nov 18 	0412 	Plot 	List
#2194 	2017 Aug 16 	1123 	2017 Sep 12 	1724 	Plot 	List
